...
{
    public class OpenProjectsForEnrtryCommand : IRequest
    {
        public bool IsOpen { get; set; }
    }

    public class OpenProjectsForEnrtryCommandHelper : AsyncRequestHandler<OpenProjectsForEnrtryCommand>
    {
        private readonly ProjectRepository _projectsRepository;
        private IUserProfileProvider _profileProvider;

        public OpenProjectsForEnrtryCommandHelper(ProjectRepository repository, IUserProfileProvider profile)
        {
