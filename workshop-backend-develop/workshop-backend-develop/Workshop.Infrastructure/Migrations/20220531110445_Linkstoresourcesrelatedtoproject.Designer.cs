...
namespace Workshop.Infrastructure.Migrations
{
    ...
    [Migration("20220531110445_Linkstoresourcesrelatedtoproject")]
    partial class Linkstoresourcesrelatedtoproject
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Workshop.Core.Domain.Model.ApiKey.ApiKey", b =>
                {
                    b.Property<long>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Workshop.Core.Domain.Model.ProjectCompetency.ProjectCompetency", b =>
                {
            ...
            modelBuilder.Entity("Workshop.Core.Domain.Model.ProjectProposal.ProjectProposal", b =>
                {
                    b.Property<long>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
                    ...
                    b.Property<string>("KeyTechnologyName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("LifeScenarioName")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Workshop.Core.Domain.Model.RequestProposal.RequestProposal", b =>
                {
                    b.Property<long>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Workshop.Core.Domain.Model.TeamSlot.TeamSlot", b =>
                {
                    b.Property<long>("Key")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("Id")
            ...
            modelBuilder.Entity("Workshop.Core.Domain.Model.UserAuditorium.UserAuditorium", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("UserId", "AuditoriumId");

                    b.HasIndex("AuditoriumId");

                    b.ToTable("UserAuditoriums");
                });
            ...
            modelBuilder.Entity("Workshop.Core.Domain.Model.ProjectProposal.ProjectProposal", b =>
                {
                    b.HasOne("Workshop.Core.Domain.Model.User.User", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("Workshop.Core.Domain.Model.TeamSlot.TeamSlot", b =>
                {
                    ...
                    b.HasOne("Workshop.Core.Domain.Model.Team.Team", "Team")
                        .WithOne("TeamSlot")
                        .HasForeignKey("Workshop.Core.Domain.Model.TeamSlot.TeamSlot", "TeamId")
                        .OnDelete(DeleteBehavior.SetNull);
                });
